...
function Header() {
    ...
    return (
        <header className="bg-sky-500 text-white shadow-md fixed top-0 left-0 w-full">
            ...
            {/* 슬라이드 메뉴 */}
            <div className={`fixed top-0 left-0 w-64 bg-sky-500 h-full z-20 transform ${isOpen ? "translate-x-0" : "-translate-x-full"} transition-transform duration-300 ease-in-out md:hidden`}>
                {/* 닫기 아이콘 */}
